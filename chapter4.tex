...
\subsection{India-Netherlands Strategic Partnership (2026--2030): Framework and Outcomes}
\begin{itemize}
    \item \textbf{Context \& Institutional Evolution:}
    \begin{itemize}
        \item \textbf{Bilateral Elevation:} Relations upgraded to a "Strategic Partnership" (2026--2030) during PM Modi's visit to the Netherlands in May 2026.
        \item \textbf{Strategic Convergence:} Focus shifted from traditional trade to high-technology partnerships ("innovation meets scale").
    \end{itemize}

    \item \textbf{Macroeconomic \& Investment Footprint:}
    \begin{itemize}
        \item \textbf{Trade Balance:} India holds a substantial trade surplus of USD 17.393 billion.
        \item \textbf{FDI Inflows:} Netherlands is India’s 4th largest investor with a cumulative FDI of USD 55.6 billion.
    \end{itemize}

    \item \textbf{Core Strategic Deliverables \& Industrial Outcomes:}
    \begin{enumerate}
        \item \textbf{Semiconductor Ecosystem:} Tata Electronics and ASML collaboration to establish a manufacturing FAB in Dholera, Gujarat.
        \item \textbf{Green Hydrogen:} Framework to expand Indian green hydrogen exports to Europe and attract infrastructure investments.
        \item \textbf{JWG on Renewable Energy:} New group targeting operational scale-up in bioenergy, battery storage, and circular feedstocks.
        \item \textbf{Critical Minerals:} Pact to secure strategic raw material supply chains and improve processing capabilities in India.
        \item \textbf{Kalpasar Project:} Technical tie-up for a massive fresh-water coastal engineering reservoir across the Gulf of Khambhat.
        \item \textbf{Customs Agreement:} Administrative pact signed to secure bilateral trade logistics and improve regulatory enforcement.
    \end{enumerate}

    \item \textbf{Agricultural, Health, and Educational Interventions:}
    \begin{itemize}
        \item \textbf{Agrarian Centers of Excellence (CoE):}
        \begin{itemize}
            \item \textit{Floriculture:} Established in West Tripura to promote high-value farming and export logistics.
            \item \textit{Dairying:} Setup at CEAH Bengaluru to enhance dairy skills, productivity, and livestock disease control.
        \end{itemize}
        \item \textbf{Public Health Alliance:} ICMR and RIVM partnership targeting infectious diseases, AMR, and digital health.
        \item \textbf{Higher Education Partnerships:} Framework for joint degrees and faculty mobility, highlighting the Nalanda-Groningen university pact.
    \end{itemize}

    \item \textbf{Cultural Diplomacy and Diasporic Welfare:}
    \begin{itemize}
        \item \textbf{Chola Artefact Repatriation:} Restitution of 11th-century Chola Copper Plates mapping historical land grants in Tamil Nadu.
    \end{itemize}
\end{itemize}
